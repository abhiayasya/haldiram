...
const HomeRevenueCards = ({data}) => {
  return (
    <div className="revenue-container p-7 flex flex-col md:flex-row items-center bg-[#FAF5EF]">
      <div className="card-img md:w-[22%]">
        <img src={revenueCard1} width={324} height={324} alt="" />
        <img src={revenueCard2} width={324} height={324} alt="" />
      </div>

      <div className="revenue-section md:w-[78%] mx-4 p-5 grid grid-cols-1 md:grid-cols-2 gap-y-6 items-center ">
          ...
          >
            <div className="mb-2 space-y-2">
              <h3 className="font-light text-2xl uppercase tracking-wider">
                <span className="text-2xl font-normal">{revenue.supTag}</span>
                {revenue.tagline}
              </h3>
