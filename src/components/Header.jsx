...
//             src={HaldiramLogo}
//             alt="Logo"
//             className="w-full lg:max-w-[150px] max-w-[100px]"
//           />
//         </div>
...
//               <a key={index} href={item.link} className="hover:text-gray-300 md:text-[13px] lg:text-base font-semibold">
//                 {item.name}
//               </a>
//             ))}
//           </nav>
...
//       {/* Mobile Menu */}
//       <div
//         className={`fixed top-0 left-0 w-full h-screen bg-black transition-transform duration-300 ${
...
//         <div className="flex justify-center space-x-4 mt-10 border border-white rounded-lg px-6 py-3 backdrop-blur-md bg-white/10">
